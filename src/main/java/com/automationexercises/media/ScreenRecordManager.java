...
public class ScreenRecordManager {
    ...
    public static void startRecording() {
        ...
        if (PropertyReader.getProperty("recordfolder").equalsIgnoreCase("true")) {
        ...
        try {
            ...
            if (recorder.get() != null) {
                ...
                String videoFilePath =
                        String.valueOf(recorder.get().stopAndSave(testMethodName));
                ...
                LogsManager.info(
                        "Recording Stopped and Converted to MP4: "
                                + mp4File.getName()
                );
            }
